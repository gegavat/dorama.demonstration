 ...
 */
final class Version20220228210507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE buyer CHANGE person_count person_count INT DEFAULT 1 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE buyer CHANGE person_count person_count INT NOT NULL');
